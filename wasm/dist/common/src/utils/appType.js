...
exports.reconstructAppType = reconstructAppType;
function reconstructAppType(json) {
    ...
    switch (json.circuit) {
        ...
        case 'disclose':
            ...
            if (json.circuit === 'disclose') {
                ...
                circuitArgs.merkle_root = json.arguments.merkle_root;
                circuitArgs.merkletree_size = json.arguments.merkletree_size;
            }
            break;
        case 'register':
    ...
    return {
        ...
        getDisclosureOptions: function () {
            if (this.circuit === 'prove' || this.circuit === 'disclose') {
                return Object.fromEntries(Object.entries(this.arguments.disclosureOptions)
